...
public class FrontRayDistance : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Ray ray_forward_right = new Ray(transform.position, transform.forward + transform.right);       
        Ray ray_forward_left = new Ray(transform.position, transform.forward - transform.right);        
